...
function guardar($estado,$comentarios,$id_pedido,$mail_usuario)
{
	...
	if ($result != false) {
		...
		if($mail_usuario!=""){
			...
			$contenido .= "<br><b>"._MSG_PEDIDO_ESTADO_ADMIN."</b><br>Status: ".$des_estado->fields[0]."<br>"._MSG_PEDIDO_COMEN_ADMIN.":<br>".$comentarios."" . "<br><br>";
			$contenido .= $contenido2->fields[0];
						$cabeceras = "MIME-Version: 1.0\r\n"; 			$cabeceras .= "Content-type: text/html; charset=utf-8\r\n"; 			$cabeceras .= "From: ".$asunto->fields[0]." <info@intimatecandy.com>\r\n";		
			mail($MailTo, $asunto->fields[0], $contenido, $cabeceras);
		}
	}else{
		$mensaje  = "0";
	}
...
?>
    ...
    <select name="reseller">
		<?php cargar_lista("ic_usuarios","us_id,CONCAT(us_nombre;' ';us_last_name),us_email,if(us_estado='1'; 'Active'; 'Inactive')","us_nombre","1",$reseller," WHERE us_id IN (SELECT id FROM ic_usu_gru WHERE gru_id=3)",$db); ?>
      </select>
    </td>
    <td>&nbsp;</td>
  </tr>
...
<table width="85%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td>
    <a href="javascript:;" onClick="javascript:document.getElementById('filtro').action='admin/excel_pedidos.php'; document.filtro.submit();" style="color:#093">
    <img src="images/excel-icon.jpg" style="display:block; float:left; margin-right:10px; margin-top:-5px;"/>
    Orders Report
    </a>
    </td>
    <td>
    <a href="javascript:;" onClick="javascript:document.getElementById('filtro').action='admin/excel_tax_state.php'; document.filtro.submit();" style="color:#093">
    <img src="images/excel-icon.jpg" style="display:block; float:left; margin-right:10px; margin-top:-5px;"/>
    Tax by State
    </a>
    </td>
    <td>
    <a href="javascript:;" onClick="javascript:document.getElementById('filtro').action='admin/excel_sales_products.php'; document.filtro.submit();" style="color:#093">
    <img src="images/excel-icon.jpg" style="display:block; float:left; margin-right:10px; margin-top:-5px;"/>
    Sales by Product
    </a>
    </td>
    <td><a href="javascript:;" onClick="javascript:document.getElementById('filtro').action='admin/excel_sales_consultant.php'; document.filtro.submit();" style="color:#093"><img src="images/excel-icon.jpg" style="display:block; float:left; margin-right:10px; margin-top:-5px;"/> Sales by Consultant </a></td>
    <td>
    <a href="admin/excel_newsletter.php" target="_blank" style="color:#093">
    <img src="images/excel-icon.jpg" style="display:block; float:left; margin-right:10px; margin-top:-5px;"/>
    Newsletter
    </a>
    </td>
...
?>
  ...
  <tr>
    ...
    <td bgcolor="#C5D0FE"><strong>Consultant</strong></td>
...
?> 
      ...
      <tr>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FDDEC8"><div align="right"><b>Sales Tax</b></div></td>
        <td bgcolor="#FDDEC8"><div align="right">
      ...
      <tr>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FFFFFF">&nbsp;</td>
        <td bgcolor="#FDDEC8"><div align="right">Shipping 
          <?="</b><br />".$envio?></div></td>
        <td bgcolor="#FDDEC8"><div align="right">
