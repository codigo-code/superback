...
<div class="container" style="padding:250px 0; background:url(images/505.jpg) center center; text-align:center">
	<h1 style="color:#fff;text-shadow: 5px 5px 5px #000;">500 - Error en la Página</h1>
	<br>
    <h1 style="color:#fff;text-shadow: 5px 5px 5px #000;">La página buscada no se encuentra en el sistema o la URL de acceso es erronea.</h1>
</div>
